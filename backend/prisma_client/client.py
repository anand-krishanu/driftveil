...
class Prisma(AsyncBasePrisma):
    ...
    machine: 'actions.MachineActions[models.Machine]'
    ...
    def __init__(
        ...
        *,
        ...
        self.machine = actions.MachineActions[models.Machine](self, models.Machine)
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.machine = MachineBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class SensorReadingBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class FailureFingerprintBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.FailureFingerprint,
            arguments={
                'data': data,
                'include': include,
            },
