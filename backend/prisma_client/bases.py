...
class BaseMachine(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Machine']] = 'Machine'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.MachineActions[_PrismaModelT]':
        from .client import get_client

        return actions.MachineActions[_PrismaModelT](client or get_client(), cls)


class BaseSensorReading(_PrismaModel):
    __prisma_model__: ClassVar[Literal['SensorReading']] = 'SensorReading'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SensorReadingActions[_PrismaModelT]':
        from .client import get_client

        return actions.SensorReadingActions[_PrismaModelT](client or get_client(), cls)


class BaseFailureFingerprint(_PrismaModel):
    __prisma_model__: ClassVar[Literal['FailureFingerprint']] = 'FailureFingerprint'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.FailureFingerprintActions[_PrismaModelT]':
        from .client import get_client

        return actions.FailureFingerprintActions[_PrismaModelT](client or get_client(), cls)
